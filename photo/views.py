...
# Photo CRUD
class PhotoCV(LoginRequiredMixin, CreateView): # photo_form.html
    model = Photo
...
# (InlineFormSet) Album Create/Update
class AlbumPhotoCV(LoginRequiredMixin, CreateView): # album_form.html
    model = Album
